...
@app.route('/api/generate_cover_letter/<job_id>', methods=['GET'])
def generate_cover_letter_api(job_id):
    try:
        ...
        return send_file(pdf_buffer, mimetype='application/pdf', as_attachment=True, download_name=request.form["email"].replace("@","_").replace(".","_")+".pdf")
