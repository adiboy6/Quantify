        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/virginiatech/"
                target="_blank"
              ...
              <a
                href="https://twitter.com/virginia_tech/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 text-gray-600 hover:text-blue-600 transition-colors"
              >
              ...
              <a
                href="https://www.linkedin.com/school/virginia-tech/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 text-gray-600 hover:text-blue-600 transition-colors"
              >
              ...
              <a
                href="https://www.instagram.com/virginia.tech/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 text-gray-600 hover:text-blue-600 transition-colors"
              >
